...
<!-- MathJax for GitHub Pages/Jekyll. Remove this block if your theme already loads MathJax. -->
...
> 本文档面向 GitHub Pages/Jekyll：正文中的行内公式统一使用 `\(...\)`，展示公式统一使用 `\[...\]`，并在页首嵌入 MathJax v3。若你的主题已经全局加载 MathJax，可以删除上方两个 `<script>` 块。
